...
class CarTransmissionTypesController extends Controller
{
    ...
    public function index(IndexCarTransmissionType $request)
    {
        ...
        return view('admin.car-transmission-type.index', ['data' => $data]);
    }
    ...
    public function store(StoreCarTransmissionType $request)
    {
        ...
        if ($request->ajax()) {
            return ['redirect' => url('admin/car-transmission-types'), 'message' => trans('brackets/admin-ui::admin.operation.succeeded')];
        }
