...
class UpdateGeneration extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'external_id' => ['nullable', Rule::unique('generations', 'external_id')->ignore($this->generation->getKey(), $this->generation->getKeyName()), 'integer'],
