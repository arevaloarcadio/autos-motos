...
class FillPermissionsForUsersFavouriteAd extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUsersFavouriteAd constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.users-favourite-ad',
            'admin.users-favourite-ad.index',
            'admin.users-favourite-ad.create',
            'admin.users-favourite-ad.show',
            'admin.users-favourite-ad.edit',
            'admin.users-favourite-ad.delete',
            'admin.users-favourite-ad.bulk-delete',
        ]);
