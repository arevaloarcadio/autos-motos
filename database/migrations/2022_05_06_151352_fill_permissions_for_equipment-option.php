...
class FillPermissionsForEquipmentOption extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEquipmentOption constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.equipment-option',
            'admin.equipment-option.index',
            'admin.equipment-option.create',
            'admin.equipment-option.show',
            'admin.equipment-option.edit',
            'admin.equipment-option.delete',
            'admin.equipment-option.bulk-delete',
        ]);
