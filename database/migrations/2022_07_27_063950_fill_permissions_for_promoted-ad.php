...
class FillPermissionsForPromotedAd extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPromotedAd constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.promoted-ad',
            'admin.promoted-ad.index',
            'admin.promoted-ad.create',
            'admin.promoted-ad.show',
            'admin.promoted-ad.edit',
            'admin.promoted-ad.delete',
            'admin.promoted-ad.bulk-delete',
        ]);
