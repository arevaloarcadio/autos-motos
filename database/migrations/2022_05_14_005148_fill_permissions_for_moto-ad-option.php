...
class FillPermissionsForMotoAdOption extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMotoAdOption constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.moto-ad-option',
            'admin.moto-ad-option.index',
            'admin.moto-ad-option.create',
            'admin.moto-ad-option.show',
            'admin.moto-ad-option.edit',
            'admin.moto-ad-option.delete',
            'admin.moto-ad-option.bulk-delete',
        ]);
