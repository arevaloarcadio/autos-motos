...
class FillPermissionsForCarMake extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCarMake constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.car-make',
            'admin.car-make.index',
            'admin.car-make.create',
            'admin.car-make.show',
            'admin.car-make.edit',
            'admin.car-make.delete',
            'admin.car-make.bulk-delete',
        ]);
