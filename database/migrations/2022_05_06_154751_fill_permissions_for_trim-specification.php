...
class FillPermissionsForTrimSpecification extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTrimSpecification constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.trim-specification',
            'admin.trim-specification.index',
            'admin.trim-specification.create',
            'admin.trim-specification.show',
            'admin.trim-specification.edit',
            'admin.trim-specification.delete',
            'admin.trim-specification.bulk-delete',
        ]);
