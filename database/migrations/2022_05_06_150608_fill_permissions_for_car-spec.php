...
class FillPermissionsForCarSpec extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCarSpec constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.car-spec',
            'admin.car-spec.index',
            'admin.car-spec.create',
            'admin.car-spec.show',
            'admin.car-spec.edit',
            'admin.car-spec.delete',
            'admin.car-spec.bulk-delete',
        ]);
