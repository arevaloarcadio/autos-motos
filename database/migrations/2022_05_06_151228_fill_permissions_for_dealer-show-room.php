...
class FillPermissionsForDealerShowRoom extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDealerShowRoom constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.dealer-show-room',
            'admin.dealer-show-room.index',
            'admin.dealer-show-room.create',
            'admin.dealer-show-room.show',
            'admin.dealer-show-room.edit',
            'admin.dealer-show-room.delete',
            'admin.dealer-show-room.bulk-delete',
        ]);
