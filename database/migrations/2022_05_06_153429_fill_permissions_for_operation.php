...
class FillPermissionsForOperation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForOperation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.operation',
            'admin.operation.index',
            'admin.operation.create',
            'admin.operation.show',
            'admin.operation.edit',
            'admin.operation.delete',
            'admin.operation.bulk-delete',
        ]);
