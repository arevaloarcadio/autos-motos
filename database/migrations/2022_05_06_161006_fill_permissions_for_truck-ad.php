...
class FillPermissionsForTruckAd extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTruckAd constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.truck-ad',
            'admin.truck-ad.index',
            'admin.truck-ad.create',
            'admin.truck-ad.show',
            'admin.truck-ad.edit',
            'admin.truck-ad.delete',
            'admin.truck-ad.bulk-delete',
        ]);
