...
class FillPermissionsForAttributeValue extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAttributeValue constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.attribute-value.index',
            'admin.attribute-value.create',
            'admin.attribute-value.show',
            'admin.attribute-value.edit',
            'admin.attribute-value.delete',
            'admin.attribute-value.bulk-delete',
        ]);
