...
class FillPermissionsForAdImageVersion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAdImageVersion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ad-image-version',
            'admin.ad-image-version.index',
            'admin.ad-image-version.create',
            'admin.ad-image-version.show',
            'admin.ad-image-version.edit',
            'admin.ad-image-version.delete',
            'admin.ad-image-version.bulk-delete',
        ]);
