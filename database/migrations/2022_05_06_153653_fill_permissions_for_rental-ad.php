...
class FillPermissionsForRentalAd extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRentalAd constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.rental-ad',
            'admin.rental-ad.index',
            'admin.rental-ad.create',
            'admin.rental-ad.show',
            'admin.rental-ad.edit',
            'admin.rental-ad.delete',
            'admin.rental-ad.bulk-delete',
        ]);
