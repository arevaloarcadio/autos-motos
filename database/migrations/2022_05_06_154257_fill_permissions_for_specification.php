...
class FillPermissionsForSpecification extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSpecification constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.specification.create',
            'admin.specification.show',
            'admin.specification.edit',
            'admin.specification.delete',
            'admin.specification.bulk-delete',
        ]);
