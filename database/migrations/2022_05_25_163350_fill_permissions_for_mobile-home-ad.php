...
class FillPermissionsForMobileHomeAd extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMobileHomeAd constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.mobile-home-ad',
            'admin.mobile-home-ad.index',
            'admin.mobile-home-ad.create',
            'admin.mobile-home-ad.show',
            'admin.mobile-home-ad.edit',
            'admin.mobile-home-ad.delete',
            'admin.mobile-home-ad.bulk-delete',
        ]);
