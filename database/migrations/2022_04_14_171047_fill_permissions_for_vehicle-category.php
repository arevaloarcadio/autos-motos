...
class FillPermissionsForVehicleCategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVehicleCategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.vehicle-category.create',
            'admin.vehicle-category.show',
            'admin.vehicle-category.edit',
            'admin.vehicle-category.delete',
            'admin.vehicle-category.bulk-delete',
        ]);
