...
class FillPermissionsForMobileHomeAdOption extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMobileHomeAdOption constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.mobile-home-ad-option',
            'admin.mobile-home-ad-option.index',
            'admin.mobile-home-ad-option.create',
            'admin.mobile-home-ad-option.show',
            'admin.mobile-home-ad-option.edit',
            'admin.mobile-home-ad-option.delete',
            'admin.mobile-home-ad-option.bulk-delete',
        ]);
