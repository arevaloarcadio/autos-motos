...
class FillPermissionsForAdModel extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAdModel constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ad-model',
            'admin.ad-model.index',
            'admin.ad-model.create',
            'admin.ad-model.show',
            'admin.ad-model.edit',
            'admin.ad-model.delete',
            'admin.ad-model.bulk-delete',
        ]);
