...
class FillPermissionsForCarTransmissionType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCarTransmissionType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.car-transmission-type',
            'admin.car-transmission-type.index',
            'admin.car-transmission-type.create',
            'admin.car-transmission-type.show',
            'admin.car-transmission-type.edit',
            'admin.car-transmission-type.delete',
            'admin.car-transmission-type.bulk-delete',
        ]);
