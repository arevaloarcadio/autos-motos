...
class FillPermissionsForCharacteristic extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCharacteristic constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.characteristic.show',
            'admin.characteristic.edit',
            'admin.characteristic.delete',
            'admin.characteristic.bulk-delete',
        ]);
