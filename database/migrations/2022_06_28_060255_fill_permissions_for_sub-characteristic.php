...
class FillPermissionsForSubCharacteristic extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSubCharacteristic constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.sub-characteristic',
            'admin.sub-characteristic.index',
            'admin.sub-characteristic.create',
            'admin.sub-characteristic.show',
            'admin.sub-characteristic.edit',
            'admin.sub-characteristic.delete',
            'admin.sub-characteristic.bulk-delete',
        ]);
