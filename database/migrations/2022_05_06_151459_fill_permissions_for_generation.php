...
class FillPermissionsForGeneration extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGeneration constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.generation',
            'admin.generation.index',
            'admin.generation.create',
            'admin.generation.show',
            'admin.generation.edit',
            'admin.generation.delete',
            'admin.generation.bulk-delete',
        ]);
