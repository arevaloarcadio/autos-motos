...
class FillPermissionsForCarFuelType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCarFuelType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.car-fuel-type',
            'admin.car-fuel-type.index',
            'admin.car-fuel-type.create',
            'admin.car-fuel-type.show',
            'admin.car-fuel-type.edit',
            'admin.car-fuel-type.delete',
            'admin.car-fuel-type.bulk-delete',
        ]);
