...
class FillPermissionsForCarModel extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCarModel constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.car-model',
            'admin.car-model.index',
            'admin.car-model.create',
            'admin.car-model.show',
            'admin.car-model.edit',
            'admin.car-model.delete',
            'admin.car-model.bulk-delete',
        ]);
