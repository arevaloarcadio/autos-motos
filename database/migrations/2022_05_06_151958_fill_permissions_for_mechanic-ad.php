...
class FillPermissionsForMechanicAd extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMechanicAd constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.mechanic-ad',
            'admin.mechanic-ad.index',
            'admin.mechanic-ad.create',
            'admin.mechanic-ad.show',
            'admin.mechanic-ad.edit',
            'admin.mechanic-ad.delete',
            'admin.mechanic-ad.bulk-delete',
        ]);
