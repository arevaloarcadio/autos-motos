...
class FillPermissionsForUsersFavouriteAdSearch extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUsersFavouriteAdSearch constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.users-favourite-ad-search',
            'admin.users-favourite-ad-search.index',
            'admin.users-favourite-ad-search.create',
            'admin.users-favourite-ad-search.show',
            'admin.users-favourite-ad-search.edit',
            'admin.users-favourite-ad-search.delete',
            'admin.users-favourite-ad-search.bulk-delete',
        ]);
