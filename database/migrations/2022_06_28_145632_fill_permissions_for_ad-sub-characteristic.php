...
class FillPermissionsForAdSubCharacteristic extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAdSubCharacteristic constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ad-sub-characteristic',
            'admin.ad-sub-characteristic.index',
            'admin.ad-sub-characteristic.create',
            'admin.ad-sub-characteristic.show',
            'admin.ad-sub-characteristic.edit',
            'admin.ad-sub-characteristic.delete',
            'admin.ad-sub-characteristic.bulk-delete',
        ]);
