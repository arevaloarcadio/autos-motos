...
class FillPermissionsForAdImage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAdImage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ad-image',
            'admin.ad-image.index',
            'admin.ad-image.create',
            'admin.ad-image.show',
            'admin.ad-image.edit',
            'admin.ad-image.delete',
            'admin.ad-image.bulk-delete',
        ]);
