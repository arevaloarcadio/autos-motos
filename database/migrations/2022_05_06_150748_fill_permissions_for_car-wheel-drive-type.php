...
class FillPermissionsForCarWheelDriveType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCarWheelDriveType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.car-wheel-drive-type',
            'admin.car-wheel-drive-type.index',
            'admin.car-wheel-drive-type.create',
            'admin.car-wheel-drive-type.show',
            'admin.car-wheel-drive-type.edit',
            'admin.car-wheel-drive-type.delete',
            'admin.car-wheel-drive-type.bulk-delete',
        ]);
