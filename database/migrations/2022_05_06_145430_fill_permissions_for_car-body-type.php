...
class FillPermissionsForCarBodyType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCarBodyType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.car-body-type',
            'admin.car-body-type.index',
            'admin.car-body-type.create',
            'admin.car-body-type.show',
            'admin.car-body-type.edit',
            'admin.car-body-type.delete',
            'admin.car-body-type.bulk-delete',
        ]);
