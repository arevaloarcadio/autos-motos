...
class FillPermissionsForAutoOption extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAutoOption constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.auto-option',
            'admin.auto-option.index',
            'admin.auto-option.create',
            'admin.auto-option.show',
            'admin.auto-option.edit',
            'admin.auto-option.delete',
            'admin.auto-option.bulk-delete',
        ]);
