...
class FillPermissionsForAutoAdOption extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAutoAdOption constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.auto-ad-option',
            'admin.auto-ad-option.index',
            'admin.auto-ad-option.create',
            'admin.auto-ad-option.show',
            'admin.auto-ad-option.edit',
            'admin.auto-ad-option.delete',
            'admin.auto-ad-option.bulk-delete',
        ]);
