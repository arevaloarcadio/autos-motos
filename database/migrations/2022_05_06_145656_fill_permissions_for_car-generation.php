...
class FillPermissionsForCarGeneration extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCarGeneration constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.car-generation',
            'admin.car-generation.index',
            'admin.car-generation.create',
            'admin.car-generation.show',
            'admin.car-generation.edit',
            'admin.car-generation.delete',
            'admin.car-generation.bulk-delete',
        ]);
