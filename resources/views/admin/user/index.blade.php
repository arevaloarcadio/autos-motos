                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'landline_number'">{{ trans('admin.user.columns.landline_number') }}</th>
                                        <th is='sortable' :column="'whatsapp_number'">{{ trans('admin.user.columns.whatsapp_number') }}</th>
                                        ...
                                        <th is='sortable' :column="'dealer_id'">{{ trans('admin.user.columns.dealer_id') }}</th>
