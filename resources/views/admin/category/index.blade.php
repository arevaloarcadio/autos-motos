                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'order_level'">{{ trans('admin.category.columns.order_level') }}</th>
                                        <th is='sortable' :column="'icon'">{{ trans('admin.category.columns.icon') }}</th>
                                        <th is='sortable' :column="'ads_type'">{{ trans('admin.category.columns.ads_type') }}</th>
                                        <th is='sortable' :column="'meta_title'">{{ trans('admin.category.columns.meta_title') }}</th>
