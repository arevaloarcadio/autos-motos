                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'car_make_id'">{{ trans('admin.car-model.columns.car_make_id') }}</th>
                                        <th is='sortable' :column="'external_id'">{{ trans('admin.car-model.columns.external_id') }}</th>
