                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'cif'">{{ trans('admin.company.columns.cif') }}</th>
                                        <th is='sortable' :column="'phone'">{{ trans('admin.company.columns.phone') }}</th>
                                        <th is='sortable' :column="'city'">{{ trans('admin.company.columns.city') }}</th>
                                        <th is='sortable' :column="'code_postal'">{{ trans('admin.company.columns.code_postal') }}</th>
                                        <th is='sortable' :column="'whatsapp'">{{ trans('admin.company.columns.whatsapp') }}</th>
                                        <th is='sortable' :column="'logo'">{{ trans('admin.company.columns.logo') }}</th>
                                        <th is='sortable' :column="'country_id'">{{ trans('admin.company.columns.country_id') }}</th>
                                        <th is='sortable' :column="'user_id'">{{ trans('admin.company.columns.user_id') }}</th>
